"""API Key detection analyzer - finds exposed API keys in responses and error messages."""
...
class APIKeyAnalyzer:
    """Active analyzer that detects exposed API keys and credentials in responses."""
    ...
    async def analyze(self, context: ScanContext) -> List[Detection]:
        """
        Scan for exposed API keys, secrets, and credentials.
